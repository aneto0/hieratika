...
class PMCTestStruct1 extends PMCVariable {
    ...
    public PMCTestStruct1(String name, String description, boolean isLiveVariable, boolean isLibrary, float var1, float var2, int var3, int var4) {
        super(name, description, new Vector(), "Test struct", new int[]{1}, true, isLiveVariable, isLibrary, null);
        this.var1 = new PMCVariable("var1", "A coefficient", new Vector(Arrays.asList(new float[]{var1})), "float32", new int[]{1}, false, false, false, new PMCValidation[]{
        ...
        this.var2 = new PMCVariable("var2", "Another coefficient", new Vector(Arrays.asList(new float[]{var2})), "float32", new int[]{1}, false, false, false, new PMCValidation[]{
            new PMCValidation("checkType", new Vector(Arrays.asList(new float[]{})), "Check the type"),
        ...
        this.var3 = new PMCVariable("var3", "And another coefficient", new Vector(Arrays.asList(new int[]{var3})), "int32", new int[]{1}, false, false, false, new PMCValidation[]{
        ...
        this.var4 = new PMCVariable("var4", "And another coefficient", new Vector(Arrays.asList(new int[]{var4})), "int32", new int[]{1}, false, false, false, new PMCValidation[]{
            new PMCValidation("checkType", new Vector(Arrays.asList(new int[]{})), "Check the type"),
