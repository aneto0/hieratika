...
class Plant55A0 {
    ...
    public PMCShape shape = new PMCShape("VAR4", "A shape", false, new PMCGap[]{
        new PMCGap("gap1", "A gap", false, 0, 0, 1, 1), 
        ...
        Arrays.asList(new PMCGap[][]{
            {
                ...
                new PMCGap("gap5", "Another gap", false, 0, 0, 2, 3)
            },
            {
                new PMCGap("gap6", "A gap", false, 0, 0, 1, 1), 
                new PMCGap("gap7", "Another gap", false, 0, 0, 2, 3)
            }
        }
        )
    ));
