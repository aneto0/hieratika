...
if not users.exists:
    ...
    db.query("CREATE TABLE variables(id TEXT, type TEXT, name TEXT, description TEXT, numberOfElements TEXT, isLiveVariable BOOLEAN, isStruct BOOLEAN, value TEXT, libraryAlias TEXT, PRIMARY KEY(id))")
