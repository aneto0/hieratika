...
class Plant55A0 {
    ...
    public PMCVariable var1 = new PMCVariable("VAR1", "A variable", "1", "int32", new int[]{1}, false, false, false,
        new PMCValidation[]{
    ...
    public PMCVariable multiDim = new PMCVariable("VAR5", "A multi dimensional variable", "", "gap", new int[]{2, 2}, true, false, false, new PMCValidation[]{}, new Vector(
