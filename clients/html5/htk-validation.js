...
export class HtkValidation {
    ...
    constructor(validationFunction) {
        this.math = HtkHelper.getMathLibrary();
 ...
 */
export class HtkValidationMath extends HtkValidation {
 ...
 */
export class HtkValidationType extends HtkValidation {
