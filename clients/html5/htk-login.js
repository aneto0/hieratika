...
`;
                ...
                export class HtkLogin extends HTMLElement {
                    ...
                    connectedCallback () {
                      ...
                      this.diag = root.querySelector("#dlogin");
                      this.loginDiv = root.querySelector("#divlogin");
                      var loginButton = root.querySelector("#loginbtn");
                      loginButton.onclick = function() {
                          var usernameTxt = root.querySelector("#username");
                          var passwordTxt = root.querySelector("#password");
                      ...
                      var cancelButton = root.querySelector("#cancelbtn");
