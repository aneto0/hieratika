 ...
 */
 ...
 export const VALUE_CHANGED_REFERENCE_NAME = 4;
    ...
    export class HtkComponent extends HTMLElement {
        ...
        /**
         * @brief HTML5 connectedCallback function. Initialise all the component variables and register the component to listen for information from the server.
         ...
         */
        connectedCallback() {
            var templateContent = this.getTemplate();
