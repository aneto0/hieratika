...
class HtkFilterEditor extends HtkComponent {
    ...
    toString () {
        ...
        if (reference === Constants.PLANT_NAME) {
            referenceValue = plantValue;
        }
        else if (reference !== Constants.NONE_NAME) {
        ...
        if (this.chart !== undefined) {
            ...
            if (this.value !== undefined) {
                ...
                if(!this.compareValues(this.numeratorInput.value, initValue[0])) {
                    this.numeratorInput.style.color = Constants.DIFF_INIT_CHANGED_COLOR;
                }
                else {
                    this.numeratorInput.style.color = Constants.STANDARD_FCOLOR;
                }
                if(!this.compareValues(this.denominatorInput.value,initValue[1])) {
                    this.denominatorInput.style.color = Constants.DIFF_INIT_CHANGED_COLOR;
                }
                else {
                    this.denominatorInput.style.color = Constants.STANDARD_FCOLOR;
                }
                if (userChanged) {
            ...
            if (ref !== Constants.NONE_NAME) {
                if (refValue !== undefined) {
                    ...
                    newBackgroundColor = Constants.STANDARD_BCOLOR;
...
window.customElements.define('htk-filter-editor', HtkFilterEditor);
